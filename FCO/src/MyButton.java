...
public class MyButton extends JButton {
    ...
    //GLOBALIZAR PATHS DE TODO EL PROGRAMA
    ...
    public MyButton(int type, int width, int height, int x, int y, Color bkgnd, ActionListener l, MouseListener m) {
        ...
        this.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(0, 0, 0), 2, true), nombre));
