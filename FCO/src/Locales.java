...
public class Locales {
    ...
    public Locales(String localisation) {
        ...
        try {
            switch (localisation) {
                case "Locale_ES":
                    reader = new Scanner(new File("C:\\Users\\david\\IdeaProjects\\GateCraft\\FCO\\src\\locales\\ES_es"));
                    break;
                case "Locale_EN":
                    reader = new Scanner(new File("C:\\Users\\david\\IdeaProjects\\GateCraft\\FCO\\src\\locales\\EN_en"));
                    break;
                default:
                    isValidFile = false;
                    break;
        ...
        if (isThereSomeSortOfError)
            JOptionPane.showMessageDialog(null, ERR_CODIGO, "Fatal ERROR in Locale", JOptionPane.ERROR_MESSAGE);
    }
